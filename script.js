...
function generatePassword(length, lower, upper, number, symbol) {
	// Add the following lines to toggle visibility of the messages
    document.getElementById("clickToCopy").style.transform = "translateY(200%)";
    document.getElementById("clickToCopy").style.opacity = "0";
    document.getElementById("copied").style.transform = "translateY(0)";
...
// Add the following lines to reset the messages when the input is changed
document.getElementById("clickToCopy").style.transform = "translateY(0)";
document.getElementById("clickToCopy").style.opacity = "1";
document.getElementById("copied").style.transform = "translateY(200%)";
